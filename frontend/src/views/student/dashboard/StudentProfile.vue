                        ...
                        <form @submit.prevent="resetPassword">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input
                                        :type="showCurrentPassword ? 'text' : 'password'" class="form-control"
                                        id="current_password" v-model="passwordReset.current_password" required
                                        minlength="8">
                                    <span class="input-group-text" @click="toggleCurrentPassword"
                                        style="cursor: pointer;">
                                        <i :class="showCurrentPassword ? 'bi bi-eye-fill' : 'bi bi-eye-slash-fill'"></i>
                                    </span>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input
                                        ...
                                        id="new_password" v-model="passwordReset.new_password" required minlength="8">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div v-if="isEditing" class="mb-3">
                            ...
                            <input type="file" id="profilePicture" ref="fileInput" accept="image/*"
                                @change="onFileSelected" class="form-control mb-3">
                            <div v-if="selectedFile" class="mb-3">
                                <button type="button" class="btn btn-outline-success" @click="uploadFile">
                                    Upload Image
                                </button>
                                <button type="button" class="btn btn-outline-danger ms-2" @click="removeFile">
                                    Remove File
                                </button>
                            </div>
                        </div>
...
const student_id = userStore.userData.id;
...
const uploadFile = async () => {
    ...
    try {
        ...
        axios.put('/api/students/' + student_id, {
...
const saveChanges = async () => {
    try {
        await axios.put('/api/students/' + student_id, user)
        getProfile()
...
const resetPassword = async () => {
    try {
        ...
        await router.push('/')
        userStore.logout()
        push.success("Login again with your new password.")
    } catch (error) {
        throw error;
    }
