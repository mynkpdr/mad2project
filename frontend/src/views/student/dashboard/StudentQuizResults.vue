            ...
            <div class="col-md-10">
                    ...
                    <div v-if="quiz_data.completed" class="col d-flex flex-column mb-4">
                        <div class="card flex-grow-1">
                            ...
                            <div class="d-flex justify-content-center mb-4">
                                <button class="btn btn-primary me-3" @click="retakeQuiz">Retake Practice</button>
                ...
                <div class="card mx-auto mb-4">
                    ...
                    <div class="card-footer border-0 d-flex justify-content-center">
                        <button class="btn btn-primary me-4" @click="retakeQuiz">Retake Practice</button>
    ...
    <div v-else-if="quiz_data.quiz_mode == 'exam'">
        <div class="container my-4 px-0">
            <div class="row">
                    ...
                    <div class="row align-items-stretch">
                        ...
                        <div v-else-if="quiz_data.completed && !Object.keys(quiz_data.result_state).length"
                            ...
                            <div class="card mx-auto mb-4">
                                ...
                                <div class="card-body text-center">
                                    <p>The result is still not published. Kindly wait for the result to be published.
                                    </p>
                                    <button class="btn btn-success"
                                        @click="router.push({ name: 'StudentDashboard' })">Go to
                                        Dashboard</button>
                                </div>
                            </div>
                        </div>
                        <div v-else class="col flex-column mb-4">
                            <div class="card mx-auto">
                                ...
                                <div class="card-body text-center">
                                    <p>You didn't complete the quiz. Do you want to Continue?.</p>
                                    <button class="btn btn-success"
                                        @click="router.push({ name: 'QuizInterface', params: { id: quiz_data.quiz_id } })">Continue
                                        the Exam</button>
                                </div>
                            </div>
                ...
                <QuizResultCharts v-if="quiz_data.completed && Object.keys(quiz_data.result_state).length"
                    class="mb-4" :quiz-data="quiz_data" />
...
const takeQuizId = route.params.id;
...
// Action handlers
const retakeQuiz = () => {
    router.push({ name: 'PracticeInterface', params: { id: quiz_data.value.quiz_id } });
    push.info("Best of luck for your next attempt!");
};
